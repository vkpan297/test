...
class DataRowsTableSeeder extends Seeder
{
    ...
    {
        $DataType      = DataType::where('slug', 'contest')->firstOrFail();
        ...
        $dataRow = $this->dataRow($DataType, "event_id");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest Id", "required" => 1, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 9, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "ticket_id");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Ticket Id", "required" => 1, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 10, ])->save();
        ...
        $dataRow = $this->dataRow($DataType, "created_at");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "timestamp", "display_name" => "Regitered On", "required" => 0, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 27, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "updated_at");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "timestamp", "display_name" => "Updated At", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 28, ])->save();
        ...
        $dataRow = $this->dataRow($DataType, "event_title");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest", "required" => 1, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" =>  [
        "disabled" => "true" 
        ], "order" => 4, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "event_start_date");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest Start Date", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 17, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "event_end_date");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest End Date", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 18, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "event_start_time");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest Start Time", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 19, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "event_end_time");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest End Time", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 20, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "event_repetitive");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest Repetitive", "required" => 1, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 21, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "ticket_title");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Ticket Title", "required" => 1, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" =>  [
        ...
        $dataRow = $this->dataRow($DataType, "event_category");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contest Category", "required" => 1, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 3, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "booking_cancel");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Contest Cancel", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 0, "delete" => 0, "details" => [
        "default" => "1", 
        "options" => [
                "1"=>"Cancellation Pending", 
                "2"=>"Approved", 
        ...
        $dataRow = $this->dataRow($DataType, "order_number");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Reg ID", "required" => 1, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => [
        "disabled" => "true" 
        ], "order" => 2, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "transaction_id");
