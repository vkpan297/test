...
Route::group([
    ...
    Route::prefix('/contest')->group(function () use ($namespace) {
        $contestcontroller = $namespace.'\ContestController';
        ...
        Route::get('/video/edit', "$contestVideocontroller@edit")->name('contestvideo.edit');

        Route::post('/store', "$contestVideocontroller@storeVideo")->name('contestvideo.store');
        Route::post('/update', "$contestVideocontroller@update")->name('contestvideo.update');
