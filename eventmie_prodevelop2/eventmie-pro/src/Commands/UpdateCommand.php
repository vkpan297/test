...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'eventmie-pro:update';
     ...
     * @var string
     */
    protected $description = 'Eventmie Pro Updater';
    ...
    private function update(Filesystem $filesystem)
    {
        ...
        $this->info('1. Migrating the Eventmie Pro database tables to update');
        $this->call('migrate', ['--force' => $this->option('force')]);
        
        // 2. Run database seeder
        $this->info('2. Running Eventmie Pro database update seeders');
        ...
        $this->info('Congrats! Eventmie Pro updated successfully to version '.$version);
    }
